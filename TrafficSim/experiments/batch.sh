...
for i in `seq 1 10`; do
	CLASSPATH=$CLASSPATH $JAVA_EXECUTABLE $JAVA_FLAGS -Xss10M -Xms1024M -Xmx1g repast.simphony.batch.BatchMain -params $PROJECT_DIR/batch/batch_params.xml $PROJECT_DIR/trafficSim.rs > $NORMLAB_DIR/experiments/$FOLDER_NAME/experiment_log_$i.log
	mv $PROJECT_DIR/experiments/logs/* $PROJECT_DIR/experiments/$FOLDER_NAME/Experiment_output_$i.txt
done
