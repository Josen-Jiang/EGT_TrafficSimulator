...
public class TrafficConfiguration {
	 ...
	 * Random seed
	 */
	public static long SIM_RANDOM_SEED = 0;
	...
	public static double SIM_CARS_DENSITY;
	//-----------------------------------------------------------------
	// IRON settings
	//-----------------------------------------------------------------
	...
	public static void init() {
		...
		SIM_MAX_TICKS = (Integer)p.getValue("SimMaxTicks");
		...
		SIM_CARS_DENSITY = (Double)p.getValue("SimCarsDensity");
